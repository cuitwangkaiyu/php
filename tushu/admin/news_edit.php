...
if($action=="save")
{
 mysql_query("update news set title='$title',content='$content' where id='".$_POST[id]."'",$conn);
...
<?php
 $sql=mysql_query("select * from news where id=".$_GET[id]."",$conn);
...
<table width="750" border="0" align="center" cellspacing="0">
  <tr>
    <td height="30" bgcolor="#E7E7E7"><div align="center" >查看修改新闻公告</div></td>
  </tr>
  <tr>
