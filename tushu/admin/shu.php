...
<?php
$q="select count(*) as total from shu ";
	   $sql=mysql_query($q);
  ...
  <tr>
	...
	<td width="60" bgcolor="#FFFFFF"><div align="center">小类</div></td>
	  ...
	  <?php
           ...
           $sql1=mysql_query("select * from shu order by addtime desc limit ".($page-1)*$pagesize.",$pagesize");
...
<table width="750" height="33" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="165">
	  <div align="left"></td>
    <td width="585"><div align="right">&nbsp;本站共有图书
        <?php
		   echo $total;
		  ?>
